	...
	var Button = function (_Component) {
	  ...
	  function Button() {
	    ...
	    var _this$props = _this.props,
	        ...
	        _this$props$colored = _this$props.colored,
	        colored = _this$props$colored === undefined ? false : _this$props$colored,
	        _this$props$ripple = _this$props.ripple,
	        ripple = _this$props$ripple === undefined ? false : _this$props$ripple,
	        _this$props$fab = _this$props.fab,
	        fab = _this$props$fab === undefined ? false : _this$props$fab;


	    _this.props.className = (0, _classnames2.default)('mdl-button mdl-js-button', {
